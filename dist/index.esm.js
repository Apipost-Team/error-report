...
class Emitter extends events.exports {
    constructor() {
        super();
        this.init();
    }
...
class ErrorObserver extends BaseObserver {
    ...
    init() {
        ...
        window.addEventListener('error', (event) => {
            ...
            self.safeEmitError(`${errorType}: ${url}`, TrackerEvents.resourceError, errorObj);
        }, true);
...
class Monitor {
    constructor(options, appVersion = {}) {
     ...
     * 初始化单例模式
    */
    static init(options = {}, appVersion = {}) {
        if (!this.instance) {
    ...
    _on(eventName, listener, withEventName = false) {
        myEmitter === null || myEmitter === void 0 ? void 0 : myEmitter.on(eventName, (...args) => __awaiter(this, void 0, void 0, function* () {
            if (withEventName) {
                args.unshift(eventName);
            }
            myEmitter === null || myEmitter === void 0 ? void 0 : myEmitter.emit(TrackerEvents._offConsoleTrack);
            yield listener(...args);
            myEmitter === null || myEmitter === void 0 ? void 0 : myEmitter.emit(TrackerEvents._onConsoleTrack);
        }));
        return this;
    }
    on(event, listener) {
...
export { BaseObserver, ConsoleType, ErrorObserver, ErrorType, Monitor, Reporter, TrackerEvents, defaultTrackerOptions };
