(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.LiMonitor = {}));
	...
	class Emitter extends events.exports {
	    ...
	    init() {
	        this.globalData = {};
	        super.on(exports.TrackerEvents._globalDataChange, (globalData) => {
	    ...
	    */
	    ...
	    _on(eventName, listener, withEventName = false) {
	        myEmitter === null || myEmitter === void 0 ? void 0 : myEmitter.on(eventName, (...args) => __awaiter(this, void 0, void 0, function* () {
	            ...
	            myEmitter === null || myEmitter === void 0 ? void 0 : myEmitter.emit(exports.TrackerEvents._offConsoleTrack);
	            yield listener(...args);
	            myEmitter === null || myEmitter === void 0 ? void 0 : myEmitter.emit(exports.TrackerEvents._onConsoleTrack);
	        }));
	        return this;
	    }
	    on(event, listener) {
